...
#property indicator_color3 DarkGreen //UPPER
#property indicator_color4 Maroon //LOWER
   ...
   if (alertsOn)
         {
            ...
            if (KFull[0]<overSold   && KFull[1]>overSold)   doAlert(overBought+" line crossed down");
         }
