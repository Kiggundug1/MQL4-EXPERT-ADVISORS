...
//
//
extern string  ____MinorEntry        = "Using fast SMA for entries too";
...
int findTrend()
{
double ElderI1 =iCustom(NULL,0,"Elder impulse - nlma for EA",13,12,26,9,0,0,2); // Elder before
double ElderI2 =iCustom(NULL,0,"Elder impulse - nlma for EA",13,12,26,9,0,0,1); // Elder now
...
if (Close[1] > iMA(NULL,0,13,0,1,0,0)) closeAbove = true;
if (Close[1] < iMA(NULL,0,13,0,1,0,0)) closeBellow = true;
